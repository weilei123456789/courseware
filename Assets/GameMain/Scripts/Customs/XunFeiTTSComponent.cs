...
namespace Penny
{
    ...
    public class XunFeiTTSComponent : GameFrameworkComponent
    {
        ...
        public void MultiSpeak(string SpeekText)
        {
            StartCoroutine(MultiSpeak(SpeekText, Speeker.小燕_青年女声_中英文_普通话));
        }

        public IEnumerator MultiSpeak(string SpeekText, Speeker speeker)
        {
            SetSpeaker(speeker);
