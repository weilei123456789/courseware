...
namespace Penny
{
    public static class AssetUtility
    {
        ...
        public static string GetLessonUISpriteAsset(string seasonPath, string path, string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/{0}/{1}/Textures/{2}.png", seasonPath, path, assetName);
        }
        ...
        public static string GetGameVideoAsset(string seasonPath, string path, string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/{0}/{1}/Movice/{2}.mp4", seasonPath, path, assetName);
        }
        ...
        public static string GetTTSSoundAsset(string seasonPath, string path, string assetName) {
            return Utility.Text.Format("Assets/GameMain/{0}/{1}/Sounds/{2}.mp3", seasonPath, path, assetName);
        }

        public static string GetLessonMusicAsset(string seasonPath, string path, string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/{0}/{1}/Sounds/{2}.mp3", seasonPath, path, assetName);
        }
